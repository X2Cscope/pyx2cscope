...
2. In COM Port, either select **Auto Connect** or select the appropriate COM Port, Baud Rate from the drop-down menus and the ELF file of the project, the microcontroller programmed with. <br>
...
6. Information related to the microcontroller will be displayed in the top-left corner.  
