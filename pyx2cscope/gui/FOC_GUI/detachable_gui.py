...
class X2cscopeGui(QMainWindow):
    ...
    def initialize_variables(self):
        ...
        # Initialize UI components that were previously missed
    ...
    def create_tabs(self):
        ...
        self.tab2 = QWidget()
        self.tab3 = QWidget()
        self.tab_widget.addTab(self.tab1, "Connection Settings")
        self.tab_widget.addTab(self.tab2, "WatchView")
        self.tab_widget.addTab(self.tab3, "ScopeView")
    ...
    def setup_tab1(self):
        """Set up the first tab with the connection settings."""
    ...
    def setup_tab2(self):
        """Set up the second tab with the WatchView functionality."""
        self.tab2.layout = QVBoxLayout()
        self.tab2.setLayout(self.tab2.layout)

        self.tab2.layout.addLayout(self.grid_layout)
        ...
        self.tab2.layout.addWidget(self.watch_plot_widget)

    def setup_tab3(self):
        """Set up the third tab with the scope functionality."""
        self.tab3.layout = QVBoxLayout()
        self.tab3.setLayout(self.tab3.layout)

        main_grid_layout = QGridLayout()
        self.tab3.layout.addLayout(main_grid_layout)
        ...
        for i, (combo, trigger_checkbox, scale_box, show_checkbox) in enumerate(
                zip(self.scope_var_combos, self.trigger_var_checkbox, self.scope_scaling_boxes, self.scope_channel_checkboxes)
        ):
        ...
        self.tab3.layout.addWidget(self.scope_plot_widget)
    ...
    def setup_connections(self):
        ...
        for combo_box, value_var in zip(self.combo_boxes, self.Value_var_boxes):
            combo_box.currentIndexChanged.connect(
                lambda cb=combo_box, v_var=value_var: self.handle_variable_getram(self.VariableList[cb.currentIndex()], v_var)
            )
        for combo_box, value_var in zip(self.combo_boxes, self.Value_var_boxes):
