...
function createScopeControlWidget(widget) {
    ...
    const sampleTime = widget.sampleTime !== undefined ? widget.sampleTime : 1;
...
function saveScopeControlConfig(widget) {
    widget.sampleTime = widget.sampleTime !== undefined ? widget.sampleTime : 1;
